...
namespace WebApplication1.Migrations
{
    public partial class AddMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //    columns: table => new
            //    {
            //        CardNumber = table.Column<decimal>(type: "numeric(16,0)", nullable: false),
            //        NameOnCard = table.Column<string>(type: "varchar(40)", unicode: false, maxLength: 40, nullable: false),
            //        CardType = table.Column<string>(type: "char(6)", unicode: false, fixedLength: true, maxLength: 6, nullable: false),
            //        CVVNumber = table.Column<decimal>(type: "numeric(3,0)", nullable: false),
            //        ExpiryDate = table.Column<DateTime>(type: "date", nullable: false),
            //        Balance = table.Column<decimal>(type: "decimal(10,2)", nullable: true)
            //    },
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("pk_CardNumber", x => x.CardNumber);
            //    });
            ...
            //    columns: table => new
            //    {
            //        ProductId = table.Column<string>(type: "char(4)", unicode: false, fixedLength: true, maxLength: 4, nullable: false),
            ...
            //        UserPassword = table.Column<string>(type: "varchar(15)", unicode: false, maxLength: 15, nullable: false),
            ...
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("pk_EmailId", x => x.EmailId);
            //        table.ForeignKey(
            //            name: "fk_RoleId",
            //            column: x => x.RoleId,
            ...
            //        Product = table.Column<string>(type: "char(4)", unicode: false, fixedLength: true, maxLength: 4, nullable: true),
            ...
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("pk_PurchaseId", x => x.PurchaseId);
            //        table.ForeignKey(
            //            name: "fk_EmailId",
            //            column: x => x.EmailId,
